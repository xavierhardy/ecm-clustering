...
public class SymboleParallelogrammeDP extends Symbole{
	public SymboleParallelogrammeDP(){
		super();
		index = 11;
	}
	
	public SymboleParallelogrammeDP(Color couleur){
		super(couleur);
		index = 11;
	}
	...
	public String toString() {
		return "Parallelogramme droite plein";
	}
}
