...
public class SymboleDiamantC extends Symbole{
	public SymboleDiamantC(){
		super();
		index = 7;
	}
	
	public SymboleDiamantC(Color couleur){
		super(couleur);
		index = 7;
	}
	...
	public void dessine(Graphics g, int x, int y, int taille){
		...
		g.drawLine(x, y - t-1, x, y + t+1);
		g.drawLine(x - t-1, y, x + t+1, y);
		g.drawPolygon(xListe, yListe, 4);
	}

	public String toString() {
		return "Diamant coche";
	}
}
