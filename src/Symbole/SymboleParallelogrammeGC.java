...
public class SymboleParallelogrammeGC extends Symbole{
	public SymboleParallelogrammeGC(){
		super();
		index = 13;
	}
	
	public SymboleParallelogrammeGC(Color couleur){
		super(couleur);
		index = 13;
	}
	...
	public String toString() {
		return "Parallelogramme gauche coche";
	}
}
