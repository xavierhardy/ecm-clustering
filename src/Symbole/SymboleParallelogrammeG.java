...
public class SymboleParallelogrammeG extends Symbole{
	public SymboleParallelogrammeG(){
		super();
		index = 12;
	}
	
	public SymboleParallelogrammeG(Color couleur){
		super(couleur);
		index = 12;
	}
