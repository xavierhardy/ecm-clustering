...
public class Fenetre extends JFrame{
	...
	private JLabel labelInfo = new JLabel("Taper un nombre et cliquer sur G�n�rer");
	...
	class itemOuvrirListener implements ActionListener{
		...
		private void charger(File f) {
			try {
				...
				//Pour simplifier le travail du programme, on ajoute une premi�re ligne qui contient le nombre de points, le nombre de dimensions, et de classes
	...
	class itemImporterListener implements ActionListener{
		...
		private void importer(File f) {
			try {
				...
				//Pour simplifier le travail du programme, on ajoute une premi�re ligne qui contient le nombre de points et le nombre de dimensions
				n = Integer.parseInt(colonnes[0]);
				dim = Integer.parseInt(colonnes[1]);
		...
		*/
		...
		public void mouseMoved(MouseEvent e) {
			...
			if(result){
				...
				labelInfo.setText("Passez la souris sur un point pour plus de d�tails");
			}
